...
namespace CityInfo.API.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        {  
            ...
            claimsForToken.Add(new Claim("sub", customer.UserId.ToString()));
            claimsForToken.Add(new Claim("given_name", customer.FirstName));
            claimsForToken.Add(new Claim("family_name", customer.LastName));
            claimsForToken.Add(new Claim("city", customer.City));
        ...
        private CustomerDetails ValidateUserCredentials(string? userName, string? password)
        {
